...
#main surfaces
testSurface=pygame.image.load('graphics/Sky.png').convert()
...
while True: 
        ...
        if game_active:
            if event.type==obstacle_timer and game_active:
                ...
                if obs:
                    ...
                    obstacle_rect_list.append(fly_surf.get_rect(midbottom=(randint(900,1100),190)))
    ...
    if game_active:
        ...
        title_surface = test_font.render('Pixel Runner',False,(64,64,64))
        title_rect=title_surface.get_rect(center=(400,50))
        screen.blit(title_surface,title_rect)

        press_play_surface = test_font.render('Press Space Key to run',False,(64,64,64))
        press_play_rect=press_play_surface.get_rect(midbottom=(400,375))
